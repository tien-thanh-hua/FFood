...
public class LoginController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("btnSubmit") != null
            ...
            String email = (String) request.getParameter("txtUsername");
            ...
            if (success) {
                ...
                if (isRemembered) {
                    if (accountType.equals("user")) {
                        ...
                        userCookie.setMaxAge(cAge);
                        userCookie.setPath("/");
                        response.addCookie(userCookie);
                        if (previousUrl != null) {
                            // Chuyển hướng người dùng về trang hiện tại
                            if (previousUrl.equals("/checkout")) {
                                List<Short> foodIdList = (List<Short>) request.getAttribute("foodIdList");
                                for (short foodId : foodIdList) {
                                    String quantityParam = (String) request.getAttribute("quantity-" + foodId);
